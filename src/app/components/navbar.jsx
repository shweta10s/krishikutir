      ...
      <div className="max-w-7xl w-full mx-auto flex items-center justify-between px-4 md:px-8">
        ...
        <ul className="hidden md:flex items-center gap-10 font-medium">
          ...
          <li className="relative group cursor-pointer">
            ...
            <ul className="absolute top-8 left-0 bg-[#fef7e6] text-[#333] shadow-lg rounded-md hidden group-hover:block min-w-[180px] mt-2 z-60">
        ...
        <div className="hidden md:block">
          <Link href="/contact">
            <button className="bg-[#4d7c0f] text-white px-5 py-2 rounded hover:bg-[#3f670d] transition cursor-pointer">
              Contact Us
            </button>
          </Link>
        </div>
            ...
            <li>
              ...
              {isShopDropdownOpen && (
                <ul className="ml-4 mt-2">
                  ...
                  <li className="py-1">
                    <Link href="/shop/product/" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-[#4d7c0f]">Product</Link>
                  </li>
                </ul>
              )}
            </li>
